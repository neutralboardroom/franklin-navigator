...
assert.ok(loader.includes("CURRENT_RELEASE='FR-NAV1.30.60-HF3.13.42'"));
...
console.log(JSON.stringify({result:'PASS',release:'FR-NAV1.30.60-HF3.13.42',scope:'R1358_PROFILE_CLAIM_CORRECTION_DEPTH'},null,2));
