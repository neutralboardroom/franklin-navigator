...
add('R1346 verification submit gives local async feedback',live.includes("submit.textContent='Submitting access request…'")&&live.includes("submitStatus.classList.add('r1346-inline-action-status')"));
add('R1346 pending review receives focus target',live.includes("pendingNotice.dataset.r1346PendingStatus=''")&&live.includes("focusIntoView('[data-r1346-pending-status]')"));
