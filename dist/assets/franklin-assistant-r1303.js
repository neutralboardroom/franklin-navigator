...
const VERSION='FR-NAV1.30.3-HF3.11.3',ROUTE_RELEASE='FR-NAV1.29.2-HF3.10.2',COMMUNITY='FRANKLIN_TN',DIR_MANIFEST='/data/discovery/manifest.json',DIR_SHA='d97640231d541f5a4f67ac26782806fc933237a39566e6e59561ea82e894e225',ANSWER_API='https://franklin-navigator-assistant.onrender.com/api/answer';
...
async function renderAnswer(raw,target,effectiveOverride=''){
  ...
  window.FranklinProductHealth?.record?.(hasFile?'assistant_r1303_file':dh.length?'assistant_r1303_profiles':'assistant_r1303_answer');
}
function makePanel(){
