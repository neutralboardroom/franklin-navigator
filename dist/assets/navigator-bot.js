(() => {
  ...
  document.querySelector('meta[name="franklin-release"]')?.setAttribute('content',VERSION);
  ...
  if(!document.getElementById('franklin-assistant-mobile-hotfix')){const s=document.createElement('style');s.id='franklin-assistant-mobile-hotfix';s.textContent=`
    ...
    @media(max-width:640px){body.hf36-home header .top{min-height:0;padding-block:7px;gap:8px 12px}body.hf36-home .brand img{width:30px;height:30px}body.hf36-home .brand-name{font-size:1.08rem}body.hf36-home .brand-subname{font-size:.68rem}body.hf36-home .r37-language-switch.hf36-language-in-header button{min-height:32px;padding:5px 7px}body.hf36-home .nav.hf34-nav{gap:12px;padding-bottom:2px;scrollbar-width:none}body.hf36-home .nav.hf34-nav::-webkit-scrollbar{display:none}body.hf36-home .nav.hf34-nav>a,body.hf36-home .nav.hf34-nav summary{white-space:nowrap;font-size:.9rem}body.hf36-home .r24-home-hero{padding-top:22px;padding-bottom:28px}body.hf36-home .r24-hero-grid{gap:18px}body.hf36-home .r24-hero-copy h1{font-size:clamp(2.2rem,10.5vw,2.8rem);line-height:1.02;letter-spacing:-.025em;margin-bottom:12px}body.hf36-home .r24-hero-lead{font-size:1rem;line-height:1.5;margin-bottom:14px}body.hf36-home .r24-trust-line{gap:7px 12px;font-size:.88rem}body.hf36-home .r24-hero-photos{margin-top:16px}body.hf36-home .navigator-bot{padding:16px;border-radius:16px}body.hf36-home .navigator-form textarea{min-height:108px}body.hf36-home .r24-ask-actions{display:grid;grid-template-columns:minmax(90px,.8fr) minmax(0,2fr);gap:8px}body.hf36-home .r24-ask-actions .button{width:100%;justify-content:center;padding-inline:10px}body.hf36-home .r24-chips{gap:7px;margin-top:10px}body.hf36-home .r24-chips button{font-size:.9rem;line-height:1.2;padding:8px 10px}.franklin-assistant-profile-grid{grid-template-columns:1fr}.franklin-assistant-profile-card{padding:12px}.franklin-assistant-profile-card .actions{display:flex;flex-wrap:wrap}.navigator-output .navigator-result,.navigator-output .franklin-assistant-local-results{overflow-wrap:anywhere}}@media(max-width:390px){body.hf36-home .r24-ask-actions{grid-template-columns:1fr}body.hf36-home .r24-hero-copy h1{font-size:2.18rem}}`;document.head.append(s)}
