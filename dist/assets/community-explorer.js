(() => {
  ...
  const text = {
    en: {
      ...
      currentNone: 'No current items match this section. Use the always-available source finder below.',
    ...
    es: {
      ...
      currentNone: 'No hay elementos actuales en esta sección. Use el buscador de fuentes disponibles en todo momento.',
