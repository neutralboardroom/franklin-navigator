(() => {
  ...
  const text = {
    en: {
      loading: 'Loading Franklin starting points…',
      loadError: 'The local activity catalog could not load. Use the official source links on this page and try again later.',
      showing: (shown, total) => `Showing ${shown} of ${total} local starting points`,
      none: 'No starting point matches those filters. Clear a filter or search a broader word.',
      source: 'Official / first-party source',
      profile: 'Open Franklin profile',
      reviewed: 'Source route checked',
      recheck: 'Schedules, registration, fees, capacity, location and eligibility can change. Recheck before relying on them.',
      add: 'Add to my short list',
      selected: count => `${count} selected`,
      emptyPlan: 'Choose one or more starting points above. No name or private story is needed.',
      planTitle: 'MY FRANKLIN ACTIVITY SHORT LIST',
      copied: 'Copied',
      copy: 'Copy list',
      download: 'Download list',
      currentNone: 'No unexpired current-window cards match this section. Use the evergreen source finder below.',
      currentSource: 'Check current source',
      filterAll: 'All'
    },
    es: {
      loading: 'Cargando puntos de partida de Franklin…',
      loadError: 'No se pudo cargar el catálogo local. Use los enlaces de fuentes oficiales de esta página e inténtelo más tarde.',
      showing: (shown, total) => `Mostrando ${shown} de ${total} puntos de partida locales`,
      none: 'Ningún punto coincide con esos filtros. Borre un filtro o use una palabra más general.',
      source: 'Fuente oficial / de primera parte',
      profile: 'Abrir perfil de Franklin',
      reviewed: 'Ruta de fuente revisada',
      ...
      emptyPlan: 'Elija uno o más puntos de partida. No se necesita ningún nombre ni historia privada.',
      planTitle: 'MI LISTA DE ACTIVIDADES DE FRANKLIN',
      copied: 'Copiado',
      copy: 'Copiar lista',
      download: 'Descargar lista',
      currentNone: 'Ninguna tarjeta vigente coincide con esta sección. Use el buscador de fuentes permanentes.',
