...
(()=>{
  ...
  function special(s){
    ...
    const fixed={
      ...
      'Claim this profile — free':'Reclamar este perfil — gratis',
      'Request management access':'Solicitar acceso de administración',
      'Correct profile information':'Corregir información del perfil',
      'Correct profile information instead':'Corregir la información del perfil en su lugar',
      'Request profile removal':'Solicitar retiro del perfil',
      ...
      'Correct profile information or request removal':'Corregir información del perfil o solicitar retiro',
      ...
      'Choose a different profile':'Elegir un perfil diferente',
