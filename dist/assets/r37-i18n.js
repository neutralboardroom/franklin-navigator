...
(()=>{
  ...
  function special(s){
    ...
    const fixed={
      ...
      'Open secure reviewer workspace':'Abrir espacio seguro de revisión',
      ...
      'You can now maintain everyday owner-controlled profile information directly. Independently sourced, identity-critical, regulated, disputed and removal-related information remains separately reviewed.':'Ahora puede mantener directamente la información cotidiana del perfil que controla el administrador. La información de fuentes independientes, crítica para la identidad, regulada, disputada o relacionada con retiros se revisa por separado.',
      'Verified manager updates':'Actualizaciones del administrador verificado',
      'Keep the everyday public details current.':'Mantenga actualizados los datos públicos cotidianos.',
      'These low-risk details are published from your verified manager account after automatic validation. They are shown as manager-provided information and do not replace independently sourced or regulated facts.':'Estos datos de bajo riesgo se publican desde su cuenta de administrador verificado después de una validación automática. Se muestran como información proporcionada por el administrador y no reemplazan datos de fuentes independientes o regulados.',
      'About this business or organization':'Acerca de esta empresa u organización',
      'A short public description.':'Una breve descripción pública.',
      'Public phone':'Teléfono público',
      'Use a public business or organization number.':'Use un número público de la empresa u organización.',
      'Official website':'Sitio web oficial',
      'Public HTTPS URL.':'URL pública HTTPS.',
      'Contact page':'Página de contacto',
      'Booking or appointment page':'Página de reservas o citas',
      'Current public-facing hours or an instruction to confirm them.':'Horario público actual o una indicación para confirmarlo.',
      'Where you provide services.':'Dónde presta servicios.',
      'Languages':'Idiomas',
      'Public-facing language support.':'Idiomas disponibles para el público.',
      'Accessibility notes':'Notas de accesibilidad',
      'Current public accessibility information.':'Información pública actual sobre accesibilidad.',
      'Identity, ownership, credentials, legal/regulatory facts, removals and disputed information still use review or source-backed correction routes. Community Membership is not required for these basic manager updates.':'La identidad, propiedad, credenciales, datos legales o regulatorios, retiros e información disputada siguen usando vías de revisión o corrección respaldadas por fuentes. La Membresía Comunitaria no es necesaria para estas actualizaciones básicas del administrador.',
      'Publish verified manager updates':'Publicar actualizaciones del administrador verificado',
      'Request a source-backed factual correction':'Solicitar una corrección factual respaldada por una fuente',
      'Recent verified-manager versions':'Versiones recientes del administrador verificado',
      'Restore this version':'Restaurar esta versión',
      'Your verified manager updates are published. Public-source facts remain separately maintained.':'Sus actualizaciones como administrador verificado están publicadas. Los datos de fuentes públicas se mantienen por separado.',
      'Earlier verified-manager version restored.':'Se restauró una versión anterior del administrador verificado.',
      'Verified manager update':'Actualización del administrador verificado',
      'Current information from this profile manager':'Información actual de este administrador del perfil',
      'These details were published by a verified manager. Independently sourced, identity-critical and regulated facts elsewhere on this profile remain separately maintained.':'Estos datos fueron publicados por un administrador verificado. Los datos de fuentes independientes, críticos para la identidad y regulados en otras partes del perfil se mantienen por separado.',
      'Reviewer access is separate from your own profile request. You cannot approve your own request; use the profile status and management actions above.':'El acceso de revisor es independiente de su propia solicitud de perfil. No puede aprobar su propia solicitud; use arriba el estado del perfil y las acciones de administración.',
      'This reviewer workspace is for unrelated requests. Your Franklin Navigator profile uses separate protected administrator access; ordinary self-review is never required.':'Este espacio de revisión es para solicitudes no relacionadas. Su perfil de Franklin Navigator usa un acceso protegido de administrador independiente; nunca se requiere la autorrevisión ordinaria.',
      'Open reviewer workspace for other requests':'Abrir espacio de revisión para otras solicitudes',
      'Before you submit':'Antes de enviar',
      'Review your correction':'Revise su corrección',
      'Confirm this removal request':'Confirme esta solicitud de retiro',
      'Confirm this correction':'Confirme esta corrección',
      'Go back and edit':'Volver y editar',
      'Submit correction':'Enviar corrección',
      'Field':'Campo',
      'Current information':'Información actual',
      'Requested change':'Cambio solicitado',
      'Evidence':'Evidencia',
      'Correct public facts or request removal':'Corregir datos públicos o solicitar retiro',
      'What needs correction?':'¿Qué necesita corrección?',
      'Choose what needs correction':'Elija qué necesita corrección',
      'Name':'Nombre',
      'Phone':'Teléfono',
      'Website or public link':'Sitio web o enlace público',
      'Address or location':'Dirección o ubicación',
      'Hours':'Horario',
      'Category or type':'Categoría o tipo',
      'Service area':'Área de servicio',
      'Closed or moved':'Cerrado o trasladado',
      'Duplicate profile':'Perfil duplicado',
      'Other':'Otro',
      'What information is wrong?':'¿Qué información es incorrecta?',
      'What should it say instead?':'¿Qué debería decir en su lugar?',
      'Removal reason':'Motivo del retiro',
      'Choose a reason':'Elija un motivo',
      'Business or organization closed':'Negocio u organización cerrada',
      'Wrong entity or profile':'Entidad o perfil incorrecto',
      'Profile should not be public under the listing rules':'El perfil no debe ser público según las reglas de publicación',
      'Privacy or safety concern':'Problema de privacidad o seguridad',
      'Explain the removal request':'Explique la solicitud de retiro',
      'Not the owner or an authorized representative? You can still report a duplicate, closure, wrong entity, or other inaccurate public information.':'¿No es propietario ni representante autorizado? Aun puede informar un perfil duplicado, un cierre, una entidad incorrecta u otra información pública inexacta.',
      'Back to this profile':'Volver a este perfil',
      'Submit free correction request':'Enviar corrección gratuita',
      'Submit free removal request':'Enviar solicitud gratuita de retiro',
      'What happens if a profile is removed':'Qué sucede si se retira un perfil',
      'Removal requests are reviewed before public visibility changes. When a removal is approved, the profile no longer appears publicly. Franklin Navigator may keep a limited internal suppression record so a routine data update does not republish it by accident.':'Las solicitudes de retiro se revisan antes de cambiar la visibilidad pública. Cuando se aprueba un retiro, el perfil deja de aparecer públicamente. Franklin Navigator puede conservar un registro interno limitado de supresión para evitar que una actualización rutinaria lo vuelva a publicar por accidente.',
      ...
      'Access request pending.':'Solicitud de acceso pendiente.',
      'This official Franklin Navigator profile uses protected administrator access. Ordinary public claims are not accepted. You can still report incorrect profile information for free.':'Este perfil oficial de Franklin Navigator usa acceso protegido de administrador. No se aceptan reclamos públicos ordinarios. Aun puede informar información incorrecta del perfil de forma gratuita.',
      'This official platform profile uses protected administrator access. Free factual corrections and removal requests remain available.':'Este perfil oficial de la plataforma usa acceso protegido de administrador. Las correcciones factuales y las solicitudes de retiro siguen siendo gratuitas.',
      'This is Franklin Navigator’s official first-party profile. Administrator access is protected; factual corrections and removal requests remain free.':'Este es el perfil oficial de Franklin Navigator. El acceso de administrador está protegido; las correcciones factuales y las solicitudes de retiro siguen siendo gratuitas.',
      ...
      'Use official website as evidence':'Usar el sitio web oficial como prueba',
      'Submitting…':'Enviando…',
