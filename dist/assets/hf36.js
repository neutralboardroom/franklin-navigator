/* FR-NAV1.29.9-HF3.10.9 simplified direct-first Franklin Assistant + fail-safe logo/loader hardening */
(()=>{'use strict';
...
const loadAssistantR1299=()=>{
  if(!document.querySelector('[data-navigator-bot]')||document.querySelector('script[data-franklin-assistant-r1299]'))return;
  ...
  load('/assets/franklin-assistant-core.js?v=frnav1292','franklin-assistant-core')
    ...
    .then(()=>load('/assets/franklin-assistant-r1299.js?v=frnav1299','franklin-assistant-r1299'))
    .then(()=>{if(!window.FranklinAssistantR1299)throw new Error('Canonical Assistant did not initialize')})
