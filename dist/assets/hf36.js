/* FR-NAV1.30.6-HF3.11.6 guide-style contextual follow-up Franklin Assistant + fail-safe logo/loader hardening */
(()=>{'use strict';
...
const loadAssistantR1306=()=>{
  if(!document.querySelector('[data-navigator-bot]')||document.querySelector('script[data-franklin-assistant-r1306]'))return;
  ...
  load('/assets/franklin-assistant-core.js?v=frnav1292','franklin-assistant-core')
    ...
    .then(()=>load('/assets/franklin-assistant-r1306.js?v=frnav1306','franklin-assistant-r1306'))
    .then(()=>{if(!window.FranklinAssistantR1306)throw new Error('Canonical Assistant did not initialize')})
