/* FR-NAV1.30.17-HF3.12.9 adaptive maximum-visible one-line navigation + site-wide issue monitoring + progressive Franklin Assistant */
(()=>{'use strict';
...
const loadAssistantR1317=()=>{
  if(!document.querySelector('[data-navigator-bot]')||document.querySelector('script[data-franklin-assistant-r1317]'))return;
  ...
  load('/assets/franklin-assistant-core.js?v=frnav1292','franklin-assistant-core')
    ...
    .then(()=>load('/assets/franklin-assistant-context-r1317.js?v=frnav1317','franklin-assistant-context-r1317'))
    .then(()=>load('/assets/franklin-assistant-r1317.js?v=frnav1317','franklin-assistant-r1317'))
    .then(()=>{if(!window.FranklinAssistantR1317)throw new Error('Canonical Assistant did not initialize')})
