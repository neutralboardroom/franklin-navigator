/* FR-NAV1.30.16-HF3.12.8 adaptive maximum-visible one-line navigation + site-wide issue monitoring + progressive Franklin Assistant */
(()=>{'use strict';
...
const loadAssistantR1316=()=>{
  if(!document.querySelector('[data-navigator-bot]')||document.querySelector('script[data-franklin-assistant-r1316]'))return;
  ...
  load('/assets/franklin-assistant-core.js?v=frnav1292','franklin-assistant-core')
    ...
    .then(()=>load('/assets/franklin-assistant-r1316.js?v=frnav1316','franklin-assistant-r1316'))
    .then(()=>{if(!window.FranklinAssistantR1316)throw new Error('Canonical Assistant did not initialize')})
