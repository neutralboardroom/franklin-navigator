/* FR-NAV1.30.0-HF3.11.0 direct-answer-only Franklin Assistant + fail-safe logo/loader hardening */
(()=>{'use strict';
...
const loadAssistantR1300=()=>{
  if(!document.querySelector('[data-navigator-bot]')||document.querySelector('script[data-franklin-assistant-r1300]'))return;
  ...
  load('/assets/franklin-assistant-core.js?v=frnav1292','franklin-assistant-core')
    ...
    .then(()=>load('/assets/franklin-assistant-r1300.js?v=frnav1300','franklin-assistant-r1300'))
    .then(()=>{if(!window.FranklinAssistantR1300)throw new Error('Canonical Assistant did not initialize')})
