...
const loadAssistantR1315=()=>{
  if(!document.querySelector('[data-navigator-bot]')||document.querySelector('script[data-franklin-assistant-r1315]'))return;
  ...
  load('/assets/franklin-assistant-core.js?v=frnav1292','franklin-assistant-core')
    ...
    .then(()=>load('/assets/franklin-assistant-r1315.js?v=frnav1315','franklin-assistant-r1315'))
    .then(()=>{if(!window.FranklinAssistantR1315)throw new Error('Canonical Assistant did not initialize')})
