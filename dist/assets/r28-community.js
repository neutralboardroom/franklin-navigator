...
(() => {
  ...
  for(const form of $$('[data-r28-plan-form]')){
    ...
    const render=()=>{const text=buildSummary(form);if(output)output.textContent=text;if(email)email.href='mailto:community@franklinnavigator.com?subject='+encodeURIComponent('See member options my Franklin member profile')+'&body='+encodeURIComponent(text+'\n\nPlease show me the next step. No payment is authorized by this email.')};
