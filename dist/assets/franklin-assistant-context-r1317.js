...
function contextualize(raw,state,C){
  ...
  const freshSubject=/\b(city hall|city offices?|schools?|parks?|recycling|recycle|trash|garbage|sanitation|transit|transportation|buses?|water|utilities?|meetings?|agenda|events?|restaurants?|doctors?|dentists?|lawyers?|attorneys?|housing|rent|landlords?|property|business(?:es)?|jobs?|childcare|daycare|permits?|roof|car|vehicles?|pets?|veterinarians?|ayuntamiento|oficinas? de la ciudad|escuelas?|parques?|reciclaje|basura|saneamiento|transporte|autobuses?|agua|servicios? publicos?|servicios? públicos?|reuniones?|agenda|eventos?|restaurantes?|medicos?|médicos?|dentistas?|abogados?|vivienda|alquiler|propietarios?|propiedad|negocios?|empleos?|guarderia|guardería|permisos?|techo|carro|vehiculos?|vehículos?|mascotas?|veterinarios?)\b/i.test(q);
  if(refersBack){
