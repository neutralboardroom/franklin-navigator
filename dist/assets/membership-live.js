...
(()=>{
  ...
  function profileSection(state,rerender){
    ...
    if(linked.authority_state==='VERIFIED'){
      ...
      actions.append(link('Open Profile Studio',studio,'button primary'),link('Correct public facts',correction));
      ...
      s.append(notice('Profile access is not yet verified. Open Profile Studio to submit or check your access request.','warn'));
    ...
    const render=()=>{
      ...
      if(state.me){
        ...
        if(profileMode){
          ...
          if(verified)box.append(link('Open Profile Studio','/profile-studio/?profile='+encodeURIComponent(verified.profile_id),'button primary'));
