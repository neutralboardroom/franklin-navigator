(() => {
  ...
  const routes={
    ...
    legal:{en:'Legal starting help',es:'Ayuda legal para comenzar',url:'/legal-help/'},
    home:{en:'Home and property help',es:'Ayuda de vivienda y propiedad',url:'/home-property-help/'},
    auto:{en:'Auto and vehicle help',es:'Ayuda de auto y vehículo',url:'/auto-vehicle-help/'},
  ...
  const t={
    en:{
      heading:'FRANKLIN WHOLE-SITUATION PLAN',
      ...
      soon:'A deadline or time-sensitive issue is present. Confirm changing deadlines or official requirements directly with the responsible source.',
    ...
    es:{
      ...
      urgency:'Urgencia',
      noStory:'Agrega una descripción breve si te ayuda a organizar la situación.',
      immediate:'Seleccionaste peligro inmediato. Usa 911 cuando exista peligro inmediato. Franklin Assistant no envía servicios de emergencia.',
      soon:'Hay un plazo o asunto urgente. Confirma los plazos cambiantes y requisitos oficiales directamente con la fuente responsable.',
      ...
      steps:['Atiende primero cualquier problema inmediato de seguridad.','Separa la situación en necesidades relacionadas en vez de obligarla a encajar en una sola categoría.','Usa los puntos de inicio de Franklin que aparecen abajo y confirma la información cambiante en las fuentes oficiales originales.','Anota los documentos, fechas, personas y preguntas que necesitas antes de contactar una oficina o profesional.','Cualquier conexión con un profesional o negocio es voluntaria; aparecer en el directorio o ser miembro no implica recomendación ni clasificación.'],
  ...
  copy?.addEventListener('click',async()=>{
    ...
    catch{copy.textContent=lang==='es'?'Selecciona y copia el plan':'Select and copy the plan'}
  });
