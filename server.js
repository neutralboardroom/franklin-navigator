...
const RELEASE = process.env.LOCAL_RELEASE || 'FR-NAV1.30.58-HF3.13.40';
...
const memberWorkflow=createMemberWorkflow({reviewers:reviewerConsole.allowedReviewerIds.length?reviewerConsole.allowedReviewerIds.join(','):process.env.MEMBER_REVIEWERS,query,tx,requireSession,readBody,sendJson:reviewerConsole.sendMemberJson,normalizeProfile,newId,audit,accessAllowed,safeEqual,adminToken:ADMIN_TOKEN,rateLimit,trustedReviewer:reviewerConsole.trustedReviewer,prepareReviewBody:reviewerConsole.prepareReviewBody,persistEvidence:reviewerConsole.persistEvidence,assertTrustedReviewer:reviewerConsole.assertTrustedReviewer,notifyRepresentationDecision:sendClaimDecisionNotification,scope:runtimeProfileScope});
