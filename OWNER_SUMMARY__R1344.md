...
The audit now covers the owner-agreed public fixes from **R1337 through R1343**. It does not count a fix as complete merely because code exists: the intended user must be able to see or naturally reach it in the normal journey.
