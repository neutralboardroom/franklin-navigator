  ...
  try{
    ...
    if(ok){
      ...
      const workflow=await client.query(`
        SELECT m.profile_id,l.authority_state,d.state AS draft_state,d.revision AS draft_revision,
