...
async function inspect(client,cfg){
  ...
  try{
    ...
    let memberships=null,reviewHistory=null,authenticatedLifecycle=null,memberWorkflow=null,memberPathReadiness=null,portfolioMemberReadiness=null;
    if(ok){
      ...
      const publicMembershipRows=(await client.query(`
        ...
        WHERE a.state='ACTIVE'
          AND l.authority_state='VERIFIED'
