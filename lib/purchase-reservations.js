...
const VERSION='FRANKLIN_CHECKOUT_SAFETY_2_SINGLE_ANNUAL';
...
async function startSafePurchase(deps,args){
  ...
  if(!args.plan||args.plan.newSaleEligible!==true)throw publicError('PLAN_RETIRED','This membership option is no longer available for new enrollment.',409);
