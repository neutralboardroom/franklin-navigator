...
async function hashPassword(password) {
  ...
  if (raw.length < PASSWORD_MIN_LENGTH || raw.length > 256) throw Object.assign(new Error('password_length_invalid'), {code:'PASSWORD_INVALID'});
...
module.exports = {sha256, randomToken, hashPassword, verifyPassword, signHmac, verifySignedRequest, verifyStripeSignature, signAssertion, safeEqual, PASSWORD_MIN_LENGTH};
