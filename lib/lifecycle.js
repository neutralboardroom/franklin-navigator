...
function mapStripeEvent(event) {
  ...
  let currentPeriodEnd = object.current_period_end ? new Date(object.current_period_end * 1000).toISOString() : linePeriodEnd ? new Date(linePeriodEnd * 1000).toISOString() : null;
